...
function Home() {
  return (
   <div className=""> <div className="w-full border-t-3 border-t-gray-700  bg-black">
      ...
      <div className="max-w-[1300px]  mx-auto text-center grid grid-cols-1 sm:grid-rows-4 sm:grid-cols-2 sm:grid-flow-col lg:grid-rows-2 lg:grid-cols-4 gap-5  px-5 py-5">
        <div className=" p-3  text-white rounded-[5px] border border-gray-400 bg-purple-700  	transition duration-700 ">
